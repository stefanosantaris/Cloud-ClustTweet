...
namespace TextPreprocessorWorkerRole.Database
{
    class DBConnect
    {
        ...
        {
            server = "oswinds2.csd.auth.gr";
            database = "slangsdb";
            uid = "santaris_thesis";
            password = "santaris_1234";
        ...
        public void SelectAll()
        {
            ...
            if (this.OpenConnection() == true)
            {
                ...
                while (dataReader.Read())
                {
                    ...
                    translation = dataReader["translation"] + "";
                    if (!WorkerRole.slangDictionary.ContainsKey(slang))
                    {
                        WorkerRole.slangDictionary.Add(slang, translation);
                    }
                }
